...
urlpatterns = [
    ...
    path('del-article-ttv/',views.article_ttv_del,name="del_article_ttv"),
    ...
    #re_path('list-article-content/(?P<id>\d+)/(?P<slug>[-\w]+)/$', list_views.article_detail, name="list_article_detail"),
